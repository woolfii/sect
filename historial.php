...
<body>
  ...
  <script src="http://code.jquery.com/jquery-latest.js"></script>
		...
		<div id="cuadro2" class="col-sm-12 col-md-12 col-lg-12 ocultar" >
			<form class="form-horizontal" action="" method="POST">
				<div class="form-group">
					...
					Formulario de Registro de Herramientas</h3>
				</div>
				<input type="hidden" id="id_herramienta" name="id_herramienta" value="0">
	...
	<div class="row">
		<div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="table-responsive col-sm-12">		
				<table id="dt_h" class="table table-bordered table-hover" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>ID</th>
							<th>Nombre</th>								
	...
	<div>
		<form id="frmEliminarHerramienta" action="" method="POST">
			<input type="hidden" id="id_herramienta" name="id_herramienta" value="">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="modalEliminarLabel">Eliminar Herramienta</h4>
						</div>
						<div class="modal-body">							
							¿Está seguro de eliminar la herramienta?<strong data-name=""></strong>
						</div>
						<div class="modal-footer">
							<button type="button" id="eliminar-herramienta" class="btn btn-primary" data-dismiss="modal">Aceptar</button>
	...
	<script>		
		...
		var eliminar = function(){
			$("#eliminar-herramienta").on("click", function(){
				var id_herramienta = $("#frmEliminarHerramienta #id_herramienta").val(),
					opcion = $("#frmEliminarHerramienta #opcion").val();
				$.ajax({
					method:"POST",
					url:"guardarherramienta.php",
		...
		if( informacion.respuesta == "BIEN" ){
			...
			texto = "<strong>Información!</strong> la herramienta ya existe.";
			color = "#5b94c5";
				...
				"buttons":[
					{
						...
						"action":function(){
							agregar_nueva_herramienta();
						}
					}
				]
			});
			obtener_data_editar("#dt_h tbody",table);
			obtener_id_eliminar("#dt_h tbody",table);
		}
		
		var agregar_nueva_herramienta= function(){
			limpiar_datos();
		...
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				...
				var id_herramienta = $("#id_herramienta").val(data.id_herramienta),
		...
		var obtener_id_eliminar = function(tbody, table){
				$(tbody).on("click", "button.eliminar", function(){
					var data = table.row($(this).parents("tr")).data();
					var id_herramienta = $("#frmEliminarHerramienta #id_herramienta").val(data.id_herramienta);
					});
			}
